...
./sim-cache -redir:sim mbq2.simout -config cache-config/cache-lru-stride.cfg mbq20
./sim-cache -redir:sim mbq6.simout -config cache-config/cache-lru-open.cfg mbq60